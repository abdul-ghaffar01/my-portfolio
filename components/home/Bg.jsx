    ...
    return (
        <motion.div variants={bgVariants}
            ...
            <div className="absolute w-full h-full flex flex-col items-center justify-center">
                ...
                <div className="absolute w-full rotate-45 h-[55px] bg-gradient-to-r from-color-900 via-color-700 to-color-500"></div>
                <div className="absolute w-full rotate-90 h-[55px] bg-gradient-to-r from-color-900 via-color-700 to-color-500"></div>
                <div className="absolute w-full rotate-[135deg] h-[55px] bg-gradient-to-r from-color-900 via-color-700 to-color-500"></div>
            </div>
        </motion.div>
    )
}
